...
class ContactsActivity : AppCompatActivity(), TextWatcher {
    ...
    //lateinit , use on property when you now it will not be null after conversion to kotlin file
    ...
    private fun loadContacts(): ArrayList<Contact> {
        ...
        val contacts = contactSet.mapTo(ArrayList()) { Gson().fromJson(it, Contact::class.java) }
        return contacts
    }
